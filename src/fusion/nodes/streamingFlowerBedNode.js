 ...
 */
 ...
 class streamingDebitmeterNode extends streamingNode {
     ...
     constructor(base, connectionConfig, config,  aggrConfigs, processRecordCb, fusionNodeI, parent) {
         ...
         "boxSize": null, 
         "consumption": 0.23, 
         "dateLastWatering": "2021-06-16T00:00:00.00Z", 
         "depth": null, "duration": 10835, 
         "feedback": "Dry plants", 
         "flowerType": null, 
         "height": null, 
         "location": null, 
         "moistureDeviceEui": null,
         "nextWateringAmountAdvice": null, 
         "nextWateringAmountRecomendation": null, 
         "nextWateringAmountRecommendation": 3.0, 
         "nextWateringDeadline": "2021-05-14T00:00:00.00Z", 
         "soilMoisture": 0, 
         "soilMoistureEc": 2.81, 
         "soilMoistureVwc": null, 
         "soilTemperature": 22.73, 
         "soilType": null, 
         "sunExposure": null, 
         "width": null}
        */
         ...
         this.base.createStore({
             ...
             fields: [
                 ...
                 { name: "soilMoistureEc", type: "float" },
     ...
     processRecord(rec) {
         ...
         let soilMoistureEc = (isNaN(rec["soilMoistureEc"]) || rec["soilMoistureEc"] == null) ? 0 : rec["soilMoistureEc"];
         ...
         combined["soilMoistureEc"] = soilMoistureEc;
